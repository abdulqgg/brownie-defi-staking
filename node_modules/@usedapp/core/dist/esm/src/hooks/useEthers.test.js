...
import { createMockProvider, renderDAppHook, setupTestingConfig } from '../testing';
...
describe('useEthers', () => {
    ...
    it('throws error if trying to use not configured network', async () => {
        ...
        await waitForCurrent((val) => !!val.error);
        expect(result.current.error).not.to.be.undefined;
        expect((_a = result.current.error) === null || _a === void 0 ? void 0 : _a.toString()).to.include(`Not configured chain id: ${Localhost.chainId}`);
    });
