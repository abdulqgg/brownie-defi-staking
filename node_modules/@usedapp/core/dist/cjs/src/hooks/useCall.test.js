    ...
    var _loop_1 = function (multicallVersion) {
        describe("Multicall v".concat(multicallVersion), function () {
            it('initial test balance to be correct', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, token, _b, result, waitForCurrent;
                var _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, (0, testing_1.setupTestingConfig)({ multicallVersion: multicallVersion })];
                        case 1:
                            _a = _d.sent(), config = _a.config, network1 = _a.network1;
                        ...
                        case 3:
                            _b = _d.sent(), result = _b.result, waitForCurrent = _b.waitForCurrent;
            ...
            it('returns error on revert', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, revertContract, _b, result, waitForCurrent;
                var _c, _d, _e;
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0: return [4 /*yield*/, (0, testing_1.setupTestingConfig)({ multicallVersion: multicallVersion })];
                        case 1:
                            _a = _f.sent(), config = _a.config, network1 = _a.network1;
                            return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(network1.deployer, constants_1.RevertContract)];
                        case 2:
                            revertContract = _f.sent();
                            return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () {
                                    return (0, __1.useCall)({
                        ...
                        case 3:
                            _b = _f.sent(), result = _b.result, waitForCurrent = _b.waitForCurrent;
                            return [4 /*yield*/, waitForCurrent(function (val) { return val !== undefined; })];
                        case 4:
                            _f.sent();
            ...
            it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, network2, token, secondToken;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            secondToken = _b.sent();
                            return [4 /*yield*/, testMultiChainUseCall(token, [network1.deployer.address], network1.chainId, testing_1.MOCK_TOKEN_INITIAL_BALANCE, config)];
                        case 4:
                            _b.sent();
                            return [4 /*yield*/, testMultiChainUseCall(secondToken, [network2.deployer.address], network2.chainId, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE, config)];
                        case 5:
                            _b.sent();
                            return [2 /*return*/];
                    }
            ...
            var testMultiChainUseCall = function (contract, args, chainId, endValue, 
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            _c.sent();
                            (0, chai_1.expect)(result.error).to.be.undefined;
                            (0, chai_1.expect)((_b = result.current) === null || _b === void 0 ? void 0 : _b.value[0]).to.eq(endValue);
                            return [2 /*return*/];
                    }
                });
            }); };
            it('Properly handles two calls', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, token, blockNumberContract, _b, result, waitForCurrent, blockNumber;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, (0, testing_1.setupTestingConfig)({ multicallVersion: multicallVersion })];
                        case 1:
                        ...
                        case 2:
                            token = _c.sent();
                            return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(network1.deployer, constants_1.BlockNumberContract)];
                        case 3:
                            blockNumberContract = _c.sent();
                            return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () {
                        ...
                        case 4:
                            _b = _c.sent(), result = _b.result, waitForCurrent = _b.waitForCurrent;
                            return [4 /*yield*/, network1.provider.getBlockNumber()];
                        case 5:
                            blockNumber = _c.sent();
                        ...
                        case 6:
                            ...
                            return [4 /*yield*/, network1.mineBlock()];
                        case 7:
                            _c.sent();
            ...
            it('Properly handles refresh per block', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, blockNumberContract, secondBlockNumberContract, _b, result, waitForCurrent, blockNumber, i;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, (0, testing_1.setupTestingConfig)({ multicallVersion: multicallVersion })];
                        case 1:
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, ethereum_waffle_1.deployContract)(network1.deployer, constants_1.BlockNumberContract)];
                        case 3:
                            secondBlockNumberContract = _c.sent();
                            return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () {
                        ...
                        case 13:
                            i++;
                            return [3 /*break*/, 11];
                        case 14: return [4 /*yield*/, (0, wait_for_expect_1["default"])(function () {
            ...
            it('Refreshes static call on parameter change', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, doublerContract, _b, waitForCurrent, rerender;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, (0, testing_1.setupTestingConfig)({ multicallVersion: multicallVersion })];
                        case 1:
            ...
            it('Refreshes only static calls with changed parameter', function () { return __awaiter(void 0, void 0, void 0, function () {
                var _a, config, network1, doublerContract, blockNumberContract, _b, waitForCurrent, rerender, result, blockNumberBefore;
                var _c, _d, _e, _f;
