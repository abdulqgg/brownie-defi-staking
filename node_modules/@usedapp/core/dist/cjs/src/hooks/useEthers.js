...
function useEthers() {
    ...
    var _c = (0, hooks_1.useConfig)(), networks = _c.networks, readOnlyUrls = _c.readOnlyUrls;
    var _d = (0, react_1.useState)(undefined), error = _d[0], setError = _d[1];
    var configuredChainIds = Object.keys(readOnlyUrls || {}).map(function (chainId) { return parseInt(chainId, 10); });
    ...
    return {
        connector: undefined,
        library: provider,
        chainId: error ? undefined : networkProvider !== undefined ? chainId : readonlyNetwork === null || readonlyNetwork === void 0 ? void 0 : readonlyNetwork.chainId,
        account: account,
        active: !!provider,
