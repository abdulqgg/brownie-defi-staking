        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    (0, chai_1.expect)((_b = result.current.error) === null || _b === void 0 ? void 0 : _b.toString()).to.include("Unsupported chain id: ".concat(network2.chainId));
                    return [2 /*return*/];
            }
        });
    }); });
    it('throws error if trying to use not configured network', function () { return __awaiter(void 0, void 0, void 0, function () {
        var notConfiguerdNetwork, _a, result, waitForCurrent;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, testing_1.createMockProvider)({ chainId: model_1.Localhost.chainId })];
                case 1:
                    notConfiguerdNetwork = _c.sent();
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () {
                            var activate = (0, useEthers_1.useEthers)().activate;
                            (0, react_1.useEffect)(function () {
                ...
                case 3:
                    _c.sent();
                    (0, chai_1.expect)(result.current.error).not.to.be.undefined;
                    (0, chai_1.expect)((_b = result.current.error) === null || _b === void 0 ? void 0 : _b.toString()).to.include("Not configured chain id: ".concat(model_1.Localhost.chainId));
                    return [2 /*return*/];
            }
        });
    }); });
